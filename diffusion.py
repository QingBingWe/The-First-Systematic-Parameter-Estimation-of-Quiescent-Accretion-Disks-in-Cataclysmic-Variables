...
def main():
    ...
    if Train:
        ...
        save_dir = "../checkpoints_new/diffusion"
        ...
        model.load_state_dict(torch.load('../checkpoints_new/diffusion/best_model.pth', map_location='cpu'))
        ...
        device = diffusion.device
        file_name = '../data/generated_data_new/cloudy_dataset_diffusion_best.h5'
